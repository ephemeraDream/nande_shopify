...
const curr_bundle_tabletop_options = bundle_tabletop_data.variant ? [...bundle_tabletop_data.variant.options] : []
        ...
        if (parent_index == 1) {
          document.querySelectorAll(".product_info_option_select[data-index='2'] .product_info_option_select_item").forEach((item, index) => {
            ...
            if (item.getAttribute("data-value") === curr_bundle_tabletop_options[2 - curr_options.length]) {
              ...
              document.querySelectorAll(".product_info_steps_contain_item_box[data-type='option'] .product_info_steps_contain_item_box_line")[2].querySelector(".product_info_steps_contain_item_box_line_value").innerHTML = item.getAttribute("data-value")
            }
          })
        }
...
function updateVariantPrice() {
  ...
  const price_op = (has_tabletop && curr_bundle_tabletop_variant) ? curr_bundle_tabletop_variant.compare_at_price || curr_bundle_tabletop_variant.price + currVariant.compare_at_price || currVariant.price : currVariant.compare_at_price
